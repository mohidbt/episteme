...
export const papersets = pgTable(
  "papersets",
  {
  ...
  (t) => [
    index("papersets_row_refs_gin").using("gin", sql`${t.rowRefs} jsonb_path_ops`),
    index("papersets_user_folder_idx").on(t.userId, t.folderId),
  ],
);
