...
-- strings → 22P02 invalid_text_representation. ALTER ... USING is
-- idempotent on text columns.
--
-- ALTER takes ACCESS EXCLUSIVE on paper_highlights. lock_timeout bounds
-- blast radius if the table is busy at apply time. Re-run after failure
-- is safe.
