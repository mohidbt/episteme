...
async def test_paper_scope_dedupes_by_page():
    ...
    result = await retrieve(conn, paper_id="00000000-0000-0000-0000-000000000001", user_id="u1", question="What is this about?",
...
async def test_paper_scope_caps_at_8():
    ...
    result = await retrieve(conn, paper_id="00000000-0000-0000-0000-000000000001", user_id="u1", question="summarize the paper",
                           scope="paper", focus_page=None, selection_text=None, api_key="sk-test")
...
async def test_selection_scope_includes_page_text():
    ...
    result = await retrieve(conn, paper_id="00000000-0000-0000-0000-000000000001", user_id="u1", question="explain this",
...
async def test_fallback_when_vector_empty():
    ...
    result = await retrieve(conn, paper_id="00000000-0000-0000-0000-000000000001", user_id="u1", question="hello",
                           scope="paper", focus_page=None, selection_text=None, api_key="sk-test")
