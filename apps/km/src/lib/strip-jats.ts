 ...
 * `<jats:italic>`). Some pipelines also leave HTML-escaped entities in the prose.
 * This is the render/ingest-time fallback used as defense-in-depth alongside the
 * source-side strip in `crossRefToCsl`.
 *
 * Kept deliberately minimal — no full HTML parser, just the common cases.
 */
